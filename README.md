...
A simple **CRUD** application built using **Spring Boot**, **Spring Data JPA**, and **H2 Database**.  
This app allows users to create, read, update, and delete To-Do tasks easily through REST APIs.
...
- ❌ Delete a To-Do
- ⚙️ REST API tested with Postman
